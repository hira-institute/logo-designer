        ...
        <Box textAlign="center" fontSize="xl">
          <Grid minH="100vh" p={3}>
            ...
            <VStack spacing={10}>
              ...
              <VStack>
                <Grid>
                  <Text fontSize="lg" textAlign="left">Height</Text>
                  <InputGroup>
                    <Input isRequired defaultValue="512px" isInvalid={this.state.height.isInvalid} placeholder="Height (Pixels)" size="md" onChange={(i) => this.handleInput("height", i)} />
                  </InputGroup>
                </Grid>
                <Grid>
                  <Text fontSize="lg" textAlign="left">Color</Text>
                  <Input isRequired defaultValue="#1b1b7a" placeholder="Color (#ffffff or white)" size="md" onChange={(i) => this.handleInput("color", i)} />
                </Grid>
                <Grid>
                  <Text fontSize="lg" textAlign="left">Caption</Text>
                  <Input disabled maxLength={12} isRequired placeholder="Coming Soon" size="md" onChange={(i) => this.handleInput("text", i)} />
                </Grid>
              </VStack>
